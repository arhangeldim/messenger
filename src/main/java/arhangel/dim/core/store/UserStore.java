...
public interface UserStore {
     ...
     * Вернуть его же
     */
    User addUser(User user) throws PersistException;

    /**
     * Обновить информацию о пользователе
     */
    User updateUser(User user) throws PersistException;
     ...
     */
    User getUser(String login, String pass) throws PersistException;
